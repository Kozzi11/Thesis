...
\projectinfo{
  ...
  keywords.en={Database, Database systems, DBMS, object database, relational database, object-relational mapping, ORM, OHM, Java Language, NoSQL, reflection, intospection.}, %klicova slova v anglickem jazyce
  %Abstract
