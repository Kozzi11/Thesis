V této kapitole Vám popíši základní informace o jazyce Java, ten je jedním z nejpopulárnějších OOP jazyků (podle Tiobe indexu) a taky má největší podporu ze stran různých objektových databází. 
\section{Java}
\input{java_language}
